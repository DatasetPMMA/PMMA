# CUDA_VISIBLE_DEVICES=0,1 PORT=29500 ./mmdetection/tools/dist_train.sh configs_faster_rcnn.py 2
_base_ = f'./mmdetection/configs/faster_rcnn/faster-rcnn_r50_fpn_1x_coco.py'
